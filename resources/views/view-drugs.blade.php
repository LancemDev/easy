    ...
    @if($drug)
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-600 overflow-hidden shadow-xl sm:rounded-lg">
                    <ul class="list-disc">
                        <li>
                            <div class="flex flex-col md:flex-row">
                                ...
                                <div class="p-4 md:w-3/4">
                                    ...
                                    <div class="mt-4 mb-10">
                                        <a href="{{ route('dashboard') }}" class="mt-4 bg-blue-500 text-white py-2 px-6 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:ring-indigo-300">Back</a>
                                    </div> 
                                </div>
                            </div>
                        </li>
